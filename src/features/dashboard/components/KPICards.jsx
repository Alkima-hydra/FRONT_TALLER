      ...
      <div className="bg-card-light dark:bg-card-dark p-6 rounded-lg border border-border-light dark:border-border-dark">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-3xl font-bold mt-2 text-[#0f49bd]">{personas.toLocaleString()}</p>
          </div>
      ...
      <div className="bg-card-light dark:bg-card-dark p-6 rounded-lg border border-border-light dark:border-border-dark">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-3xl font-bold mt-2 text-[#0f49bd]">{sacramentos.toLocaleString()}</p>
          </div>
          <div className="h-12 w-12 bg-[#0f49bd]/10 rounded-full flex items-center justify-center">
      ...
      <div className="bg-card-light dark:bg-card-dark p-6 rounded-lg border border-border-light dark:border-border-dark">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-3xl font-bold mt-2 text-[#0f49bd]">{parroquias.toLocaleString()}</p>
          </div>
          <div className="h-12 w-12 bg-[#0f49bd]/10 rounded-full flex items-center justify-center">
